...
def main():
    ...
    add_content_slide(prs,
        ...
        [
            ...
            "",
            "   • Среднее время распределения (сложность товара)",
            "   • Типичное количество в задании (мин, макс, медиана)",
            "   • Вариативность времени (стабильность)",
            "   • Частота появления (приоритет оптимизации)",
            "",
            "Использование:",
            "   • Прогноз времени волны = Σ (кол-во × время на единицу)",
            "   • Выявление 'проблемных' товаров",
            "   • Частые товары → ближе к выходу из буфера"
        ])
    ...
    # Slide 10: Example
    add_content_slide(prs,
        "9. Пример: волна из 50 заданий",
        [
            "БЕЗ оптимизации:",
            "   Карщик 1: ████████████████████████ (перегружен)",
            "   Карщик 2: ████████░░░░░░░░░░░░░░░░ (недогружен)",
            "   Карщик 3: ██████████████░░░░░░░░░░ (средне)",
            "   Время волны: 45 минут, простои: 12%",
            "",
            "С оптимизацией OR-Tools:",
            "   Карщик 1: ████████████████░░░░░░░░ (сбалансировано)",
            "   Карщик 2: ███████████████░░░░░░░░░ (сбалансировано)",
            "   Карщик 3: ████████████████░░░░░░░░ (сбалансировано)",
            "   Время волны: 32 минуты (-29%), простои: 3%"
        ])
