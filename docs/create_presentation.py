...
def main():
    ...
    add_content_slide(prs,
        ...
        [
            ...
            "",
            "ML модель учитывает связку: пикер + товар + время → скорость",
            "",
            "Результат: задача идёт к тому, кто выполнит её быстрее"
        ])

    # Slide 7: OR-Tools
    add_content_slide(prs,
        "6. Оптимизация расписания (OR-Tools)",
        [
    ...
    add_diagram_slide(prs,
        "7. Цикл оптимизации (каждые 15 минут)",
